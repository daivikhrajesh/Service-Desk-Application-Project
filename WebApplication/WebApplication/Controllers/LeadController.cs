...
namespace WebApplication.Controllers
{
    public class LeadController : Controller
    {
        ...
        public ActionResult Group(GroupViewModel grp)
        {
            ...
            {
                return RedirectToAction("GroupTicket", "Admin", new { grpname = grp.Group_Name });
            }
            else
            {
        ...
        [HttpGet]
        public ActionResult GroupTicket()
        {
            var grp = Session["GrpName"].ToString();
            var data = db.Tickets.Where(x => x.Ticket_By.Group.Group_Name == grp ).ToList();
            return View(data);
